...
function edit(c){reset();["name","role","age","height","hair","eyes","power","weapon","group_name","city","description"].forEach(k=>$(k).value=c[k]||"");$("id").value=c.id;$("oldImage").value=c.image_url||"";if(c.image_url){$("preview").src=c.image_url;$("preview").classList.remove("hidden")}$("deleteBtn").classList.remove("hidden");$("formTitle").textContent="Edit Karakter";$("detailDialog").close();$("charDialog").showModal()}
