...
function edit(c){
  ...
  ["name","role","age","height","hair","eyes","power","weapon","group_name","city","description","story","first_chapter"]
    .forEach(k => {
      if ($(k)) $(k).value = c[k] || "";
    });

  $("id").value = c.id;
  $("oldImage").value = c.image_url || "";
  ...
  $("formTitle").textContent = "Edit Karakter";
